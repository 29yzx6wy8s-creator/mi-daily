...
import type { Balances as _Balances, RegistrationError as _RegistrationError, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getCallerBalances(): Promise<{
        __kind__: "ok";
        ok: Balances;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getCallerBalances();
    ...
    async transfer(arg0: string, arg1: string, arg2: bigint): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async updateCallerBalances(arg0: Balances): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.updateCallerBalances(arg0);
                return from_candid_variant_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_RegistrationError_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RegistrationError): RegistrationError {
...
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ok" in value ? {
        ...
        __kind__: "err",
        err: from_candid_RegistrationError_n4(_uploadFile, _downloadFile, value.err)
    } : value;
}
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "phoneNumberInUse" in value ? RegistrationError.phoneNumberInUse : "userNotFound" in value ? RegistrationError.userNotFound : "balanceOutOfRange" in value ? RegistrationError.balanceOutOfRange : "incorrectPassword" in value ? RegistrationError.incorrectPassword : "unauthorized" in value ? RegistrationError.unauthorized : "userNotRegistered" in value ? RegistrationError.userNotRegistered : value;
}
